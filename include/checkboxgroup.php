...
<form method="post">
	...
	<label for="cf_edit_label_group"><?php _e('Field label', 'cforms2'); ?></label>
	...
	<div class="cf_edit_groups_header">
		...
		<span class="cf_br dashicons dashicons-editor-break" title="<?php _e('Carriage return / New Line', 'cforms2'); ?>"></span>
	</div>
