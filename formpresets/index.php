...
__("Default: Reset to *default* contact form", "cforms2");
__("Does what it says, it'll reset all input fields to the default setup.", "cforms2");
__("Basic: Preset for *GREY BLOCKS* Theme", "cforms2");
