...
<form method="post">
	...
	<div class="cf_edit_groups_header">
		...
		<span class="cf_chked dashicons dashicons-yes" title="<?php _e('Set default state', 'cforms'); ?>"></span>
		<span class="cf_br dashicons dashicons-editor-break" title="<?php _e('Carriage return / New Line', 'cforms'); ?>"></span>
	</div>
