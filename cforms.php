...
define('CFORMS2_VERSION', '14.13.1');
...
function cforms2($args = '', $no = '') {
    ...
    elseif (($upload || $custom || $alt_action) && $cformsSettings['form' . $no]['cforms' . $no . '_ajax'] == '1')
...
function cforms2_findlast($haystack, $needle, $offset = null) {
    if (($pos = strpos(strrev($haystack), strrev($needle), $offset)) === false)
        return false;
